...
> [THREAT_MODEL.md §5.8](THREAT_MODEL.md#58-간접-프롬프트-인젝션--lethal-trifecta--에이전트-경계-b5--자산-a2)
> 가, 실행 평면 구현 맥락은 [ARCHITECTURE.md](ARCHITECTURE.md)(§12 워크플로우/cron, §14 PO 루프)가 묶는다.
>
...
[THREAT_MODEL.md §5.8](THREAT_MODEL.md#58-간접-프롬프트-인젝션--lethal-trifecta--에이전트-경계-b5--자산-a2),
수용 잔여 위험을 [§6](THREAT_MODEL.md#6-수용된-잔여-위험-accepted-residual-risk)에 기록했다.
